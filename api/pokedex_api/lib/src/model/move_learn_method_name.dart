...
/// * [language]
@BuiltValue()
abstract class MoveLearnMethodName
    implements Built<MoveLearnMethodName, MoveLearnMethodNameBuilder> {
  ...
  factory MoveLearnMethodName([void updates(MoveLearnMethodNameBuilder b)]) =
      _$MoveLearnMethodName;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MoveLearnMethodNameBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MoveLearnMethodName> get serializer =>
      _$MoveLearnMethodNameSerializer();
}

class _$MoveLearnMethodNameSerializer
    implements PrimitiveSerializer<MoveLearnMethodName> {
  @override
