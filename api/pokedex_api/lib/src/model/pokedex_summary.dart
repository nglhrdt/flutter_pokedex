...
/// * [url]
@BuiltValue()
abstract class PokedexSummary
    implements Built<PokedexSummary, PokedexSummaryBuilder> {
  ...
  factory PokedexSummary([void updates(PokedexSummaryBuilder b)]) =
      _$PokedexSummary;
  ...
  static Serializer<PokedexSummary> get serializer =>
      _$PokedexSummarySerializer();
}

class _$PokedexSummarySerializer
    implements PrimitiveSerializer<PokedexSummary> {
  @override
