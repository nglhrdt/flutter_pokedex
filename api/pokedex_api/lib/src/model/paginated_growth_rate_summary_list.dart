...
/// * [results]
@BuiltValue()
abstract class PaginatedGrowthRateSummaryList
    implements
        Built<PaginatedGrowthRateSummaryList,
  ...
  factory PaginatedGrowthRateSummaryList(
          [void updates(PaginatedGrowthRateSummaryListBuilder b)]) =
      _$PaginatedGrowthRateSummaryList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaginatedGrowthRateSummaryListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaginatedGrowthRateSummaryList> get serializer =>
      _$PaginatedGrowthRateSummaryListSerializer();
}

class _$PaginatedGrowthRateSummaryListSerializer
    implements PrimitiveSerializer<PaginatedGrowthRateSummaryList> {
  @override
      ...
      switch (key) {
        ...
        case r'results':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(BuiltList, [FullType(GrowthRateSummary)]),
