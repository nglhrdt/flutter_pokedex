...
/// * [language]
@BuiltValue()
abstract class PokemonColorName
    implements Built<PokemonColorName, PokemonColorNameBuilder> {
  ...
  factory PokemonColorName([void updates(PokemonColorNameBuilder b)]) =
      _$PokemonColorName;
  ...
  static Serializer<PokemonColorName> get serializer =>
      _$PokemonColorNameSerializer();
}

class _$PokemonColorNameSerializer
    implements PrimitiveSerializer<PokemonColorName> {
  @override
