...
class LocationApi {
  ...
  Future<Response<LocationAreaDetail>> locationAreaRetrieve({
    ...
    final _path = r'/api/v2/location-area/{id}/'.replaceAll('{' r'id' '}',
  ...
  Future<Response<LocationDetail>> locationRetrieve({
    ...
    final _path = r'/api/v2/location/{id}/'.replaceAll(
        '{' r'id' '}',
  ...
  Future<Response<PalParkAreaDetail>> palParkAreaRetrieve({
    ...
    final _path = r'/api/v2/pal-park-area/{id}/'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<RegionDetail>> regionRetrieve({
    ...
    final _path = r'/api/v2/region/{id}/'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
