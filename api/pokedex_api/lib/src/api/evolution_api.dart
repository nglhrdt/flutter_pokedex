...
class EvolutionApi {
  ...
  Future<Response<EvolutionChainDetail>> evolutionChainRetrieve({
    ...
    final _path = r'/api/v2/evolution-chain/{id}/'.replaceAll(
        '{' r'id' '}',
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(PaginatedEvolutionTriggerSummaryList),
  ...
  Future<Response<EvolutionTriggerDetail>> evolutionTriggerRetrieve({
    ...
    final _path = r'/api/v2/evolution-trigger/{id}/'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(String))
            .toString());
    final _options = Options(
